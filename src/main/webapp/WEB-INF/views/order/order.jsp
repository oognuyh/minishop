                            ...
                            <div class="card-body">
                                <div class="row" v-for="orderDetail in order.orderDetails">
                                    ...
                                    <div class="d-flex flex-column justify-content-between">
                                        ...
                                        <p class="mb-3 text-muted text-uppercase small">Size: {{ orderDetail.productSize }}</p>
                                        <p class="mb-3 text-muted text-uppercase small">Quantity: {{ orderDetail.productQuantity }}</p>
                                        <p class="mb-3 text-muted text-uppercase small">Total Price: {{ orderDetail.totalPrice }}</p>
                                    </div>
                                </div>
